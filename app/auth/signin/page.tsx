  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
      ...
      <div className="mb-[100px] text-center">
        ...
        <h1 className="text-[40px] leading-12 text-[#2E2E2E] font-medium tracking-tight">
          Sign In to your account
        </h1>
        <p className="text-gray-500 mt-4 text-[18px]">
          Unlock exclusive access to premium components <br /> and design
          resources.
        </p>
      </div>
      ...
      <div className="w-full max-w-[552px] bg-gray-100 rounded-[34px] p-3">
        ...
        <form className="bg-white p-8 rounded-3xl space-y-5 shadow-[0_6px_20px_0px_rgba(0,0,0,0.03),2px_20px_20px_0px_rgba(0,0,0,0.03),-2px_20px_20px_0px_rgba(0,0,0,0.03)]">
          ...
          <button
            type="submit"
            className="w-full bg-[#3758f9] text-white text-[16px] py-3.5 rounded-xl hover:bg-blue-700 transition font-medium shadow-sm"
          >
            Sign Up
          </button>
